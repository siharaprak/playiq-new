...
import { Module3BossBattleForm } from './Module3BossBattleForm';

export default async function Module3BossBattlePage() {
  await enforceModuleGating('boss-battle', 3);
  ...
  return (
    <div className="flex flex-col min-h-screen px-6 py-12 max-w-4xl mx-auto">
      ...
      <div className="bg-slate-900 border border-[#7b4fce]/50 p-6 rounded-xl shadow-[0_0_20px_rgba(123,79,206,0.15)] font-mono text-sm text-slate-300 mb-10">
        ...
        <p className="mb-4">This is your final challenge for Module 3. For each of the 6 scenarios, you will:</p>
