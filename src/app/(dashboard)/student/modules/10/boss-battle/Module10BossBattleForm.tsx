...
export function Module10BossBattleForm() {
    ...
    <form action={formAction} className="space-y-8">
      ...
      <div className="flex justify-end pt-4">
        <button
          type="submit"
          disabled={isPending}
          className="w-full md:w-auto px-10 py-4 rounded-lg font-bold uppercase tracking-widest transition-opacity hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
