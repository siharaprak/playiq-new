...
export function Module1QuizForm() {
  ...
  return (
    <form action={formAction} className="space-y-10">
      ...
      <div className="bg-slate-800/60 p-8 rounded-xl border border-slate-700/50 backdrop-blur-md">
        <h3 className="text-[#39ff14] font-bold uppercase tracking-widest text-xs mb-6 border-b border-slate-700 pb-2">
          PART A — POWER AND TRUTH
        </h3>
        <div className="space-y-6">
          <div>
            ...
            <div className="space-y-2">
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q1" value="a" required /> A. It always makes people smarter
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q1" value="b" /> B. It makes your habits and choices stronger in whatever direction they already go
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q1" value="c" /> C. It makes the internet faster
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q1" value="d" /> D. It copies people&apos;s thoughts
              </label>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-slate-700/50">
            ...
            <div className="space-y-2">
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q2" value="a" required /> A. Believe what sounds confident
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q2" value="b" /> B. Share first, check later
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q2" value="c" /> C. Compare it with another trusted source
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q2" value="d" /> D. Trust popular opinions
              </label>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-slate-700/50">
            ...
            <div className="space-y-2">
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q3" value="a" required /> A. Because repeated things are always false
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q3" value="b" /> B. Because something can be repeated and still be wrong
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q3" value="c" /> C. Because the internet hides truth
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q3" value="d" /> D. Because teachers do not like repetition
              </label>
            </div>
          </div>
        </div>
      ...
      <div className="bg-slate-800/60 p-8 rounded-xl border border-slate-700/50 backdrop-blur-md">
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="space-y-2">
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q4" value="a" required /> A. Rest builds you; escape avoids what matters
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q4" value="b" /> B. Escape is always good
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q4" value="c" /> C. Rest is only for weekends
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q4" value="d" /> D. They are the same thing
              </label>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-slate-700/50">
            ...
            <div className="space-y-2">
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q5" value="a" required /> A. Will this make me look smart?
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q5" value="b" /> B. Does this make me stronger or weaker?
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q5" value="c" /> C. Can I avoid effort here?
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q5" value="d" /> D. Will this help me finish faster no matter what?
              </label>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-slate-700/50">
            ...
            <div className="space-y-2">
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q6" value="a" required /> A. Copying an AI answer because it sounds good
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q6" value="b" /> B. Asking AI to explain a concept and then writing your own answer
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q6" value="c" /> C. Scrolling when you meant to study
              </label>
              <label className="flex gap-3 text-sm text-slate-300 cursor-pointer">
                <input type="radio" name="q6" value="d" /> D. Believing something because it matches your opinion
              </label>
            </div>
          </div>
        </div>
      ...
      <div className="flex justify-end pt-4">
        <button
          type="submit"
          disabled={isPending}
          className="btn-neon-filled w-full md:w-auto px-10 py-4 rounded-lg font-bold uppercase tracking-widest disabled:opacity-50"
        >
          {isPending ? 'Grading Answers...' : 'Submit Quiz & Verify →'}
        </button>
      </div>
    </form>
  );
