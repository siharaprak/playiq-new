  ...
  return (
    <main className="w-full">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#020617] star-field border-b-4 border-b-[#7b4fce]">
        ...
        <div className="absolute top-[20%] right-[3%] font-display tracking-[0.3em] text-[#00c8ff] text-[0.6rem] uppercase opacity-60 text-right hidden sm:block pointer-events-none">
          SYS.INIT // v.2.0.4<br/>
          CONNECTING...
        </div>
        <div className="absolute bottom-[10%] left-[8%] font-display tracking-[0.3em] text-[#7b4fce] text-[0.6rem] uppercase opacity-60 hidden sm:block pointer-events-none">
          [SYSTEM_READY]<br/>
          STATUS: ONLINE
        </div>

        <div className="relative z-10 w-full max-w-7xl px-4 pt-8 sm:pt-16 pb-8 sm:pb-12 flex flex-col items-center justify-center">
          {/* MASSIVE Logo */}
          <div className="animate-fade-in-up mb-4 sm:mb-6 w-full text-center">
            <PlayIQLogo variant="hero" className="mx-auto" />
          </div>

          <div className="glass-card !bg-transparent !border-none !backdrop-blur-none text-center max-w-4xl mx-auto flex flex-col items-center gap-4 sm:gap-6 mt-[-0.5rem] md:mt-[-2rem]">
            <p className="animate-fade-in-up font-display font-bold text-xs md:text-sm uppercase tracking-[0.3em] sm:tracking-[0.4em] text-[#7b4fce] text-glow-magenta bg-black/50 px-3 sm:px-4 py-1 border border-[#7b4fce]"
               style={{ animationDelay: '0.2s' }}>
              IMAGINE &gt; BUILD &gt; CONQUER
            </p>

            <div className="text-center animate-fade-in-up w-full" style={{ animationDelay: '0.4s' }}>
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold text-white leading-tight uppercase font-display tracking-wider sm:tracking-widest drop-shadow-[2px_2px_0_#7b4fce]">
                Master Your <br/>
                <span className="text-[#00c8ff] text-glow-cyan text-[1.2em]">Learning</span>
              </h2>
              <p className="mt-6 sm:mt-8 text-sm md:text-lg text-slate-300 font-bold max-w-2xl mx-auto uppercase tracking-wide">
                Where advanced cognitive strategy meets AI-powered mentorship.
              </p>
              <p className="mt-3 sm:mt-4 text-xs md:text-sm text-slate-400 font-mono max-w-2xl mx-auto uppercase tracking-wider">
                &gt; Optimized for ages 13–17. Providing safer screen time, structured STEM learning, and cognitive development.
              </p>
              
              <div className="mt-8 sm:mt-12 flex flex-col items-center justify-center gap-6">
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full justify-center max-w-md sm:max-w-none">
                  <Link 
                    href="/beta"
                    className="w-full sm:w-auto font-display uppercase font-bold text-sm tracking-[0.1em] px-8 py-3.5 min-h-[48px] flex items-center justify-center transition-all border-2 bg-[#00c8ff] text-[#020617] border-[#00c8ff] shadow-[0_0_20px_#00c8ff] hover:bg-white hover:border-white hover:text-black active:scale-[0.98]"
                  >
                    Apply for Pilot Access
                  </Link>
                  <Link 
                    href="/how-it-works"
                    className="w-full sm:w-auto font-display uppercase font-bold text-sm tracking-[0.1em] px-8 py-3.5 min-h-[48px] flex items-center justify-center transition-all border-2 bg-transparent text-white border-white/30 hover:border-[#7b4fce] hover:shadow-[0_0_15px_#7b4fce] active:scale-[0.98]"
                  >
                    See How It Works
                  </Link>
                </div>
      ...
      <section className="relative px-4 sm:px-6 py-12 sm:py-16 md:py-20 overflow-hidden bg-space-gradient star-field border-b border-slate-800/50">
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16">
            <h2 className="font-display text-xs uppercase tracking-[0.25em] text-[#00c8ff] text-glow-cyan mb-3 sm:mb-4">
              Dual Perspective
            </h2>
            ...
            <p className="mt-3 sm:mt-4 text-slate-400 text-xs sm:text-sm md:text-base leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 font-mono">
            <div className="glass-card p-5 sm:p-8 border-l-4 border-l-[#00c8ff]">
              <h4 className="font-display text-xs sm:text-sm uppercase tracking-wider text-[#00c8ff] font-bold mb-3 sm:mb-4">[ FOR TEENS: BUILD COOL STUFF ]</h4>
              <ul className="space-y-2.5 sm:space-y-3 text-xs text-slate-400 uppercase tracking-widest leading-relaxed">
            ...
            <div className="glass-card p-5 sm:p-8 border-l-4 border-l-[#7b4fce]">
              <h4 className="font-display text-xs sm:text-sm uppercase tracking-wider text-[#7b4fce] font-bold mb-3 sm:mb-4">[ FOR PARENTS: MEASURABLE COMPETENCY ]</h4>
              <ul className="space-y-2.5 sm:space-y-3 text-xs text-slate-400 uppercase tracking-widest leading-relaxed">
      ...
      <section className="relative px-4 sm:px-6 py-12 sm:py-16 md:py-24 overflow-hidden bg-[#0a0f1e] border-b border-slate-800/50">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 font-mono">
            {[
              ...
              <div key={mod.num} className="glass-card glass-card-hover p-4 sm:p-6 border-l-2 border-l-[#00c8ff]/40">
                <div className="text-[#00c8ff] font-bold text-base sm:text-lg mb-1.5 sm:mb-2 tracking-widest">[{mod.num}] {mod.title}</div>
                <p className="text-[11px] sm:text-xs text-slate-400 uppercase tracking-wide leading-relaxed">{mod.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative px-4 sm:px-6 py-12 sm:py-16 md:py-24 overflow-hidden animate-fade-in-up" style={{ background: '#0b1120' }}>
        <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14">
            ...
            <p className="mt-3 sm:mt-4 text-slate-400 text-xs sm:text-sm md:text-base max-w-2xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <div
                key={item.title}
                className="glass-card glass-card-hover p-5 sm:p-7 text-center"
                style={{ animationDelay: `${i * 0.15}s` }}
              >
                <div className="text-2xl sm:text-3xl mb-3 sm:mb-4">{item.icon}</div>
                <h4 className="font-display text-xs sm:text-sm uppercase tracking-wider text-[#00c8ff] font-bold mb-2 sm:mb-3">
                  {item.title}
                </h4>
      ...
      <section className="relative px-4 sm:px-6 py-12 sm:py-16 md:py-24 bg-space-gradient star-field overflow-hidden animate-fade-in-up">
        <div className="relative z-10 mx-auto max-w-4xl">
          <div className="glass-card glass-card-hover p-5 sm:p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 md:gap-8 glow-border-cyan">
            <div className="circle-frame animate-float shrink-0" style={{ animationDelay: '1s' }}>
              <Image
                ...
                priority
                unoptimized
                className="w-36 h-36 sm:w-48 sm:h-48 md:w-[220px] md:h-[220px]"
              />
            </div>
            <div className="text-center md:text-left flex-1">
              ...
              <p className="mt-2.5 sm:mt-3 text-slate-400 text-xs sm:text-sm md:text-base">
              ...
              <div className="mt-4 sm:mt-5 flex justify-center md:justify-start">
                <Link href="/apprentice" className="btn-neon-cyan min-h-[44px] inline-flex items-center">
                  Start Now
                </Link>
              </div>
            </div>
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="flex flex-col md:flex-row items-center gap-8 sm:gap-12 md:gap-16">
            ...
            <div className="w-full md:w-1/2 flex justify-center">
              <div className="glass-card p-2.5 sm:p-3 rounded-2xl glow-border-cyan overflow-hidden animate-float w-full max-w-lg" style={{ animationDelay: '1.5s' }}>
                <Image
            ...
            <div className="w-full md:w-1/2 text-center md:text-left">
              ...
              <p className="mt-4 sm:mt-5 text-slate-400 text-xs sm:text-sm md:text-base leading-relaxed">
              ...
              <p className="mt-2.5 sm:mt-3 text-slate-400 text-xs sm:text-sm md:text-base leading-relaxed">
              ...
              <div className="mt-5 sm:mt-6 flex justify-center md:justify-start">
                <Link href="/parents" className="btn-neon-purple min-h-[44px] inline-flex items-center">
      ...
      <section className="relative px-4 sm:px-6 py-12 sm:py-16 md:py-24 overflow-hidden bg-[#0a0f1e] border-t border-slate-800/30">
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-400 text-xs sm:text-sm md:text-base leading-relaxed max-w-2xl mx-auto mb-8 sm:mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 text-left font-mono">
            <div className="glass-card p-5 sm:p-8 border-l-4 border-l-[#00c8ff]">
              <div className="text-xs text-[#00c8ff] font-bold uppercase mb-2">[ PILOT COHORT ]</div>
              <h4 className="text-lg sm:text-xl text-white font-bold mb-3 sm:mb-4 uppercase">Early Access Free Tier</h4>
              <p className="text-xs text-slate-400 uppercase leading-relaxed mb-4 sm:mb-6">
              ...
              <div className="text-base sm:text-lg text-[#00c8ff] font-bold uppercase tracking-widest">$0 / MONTH</div>
            </div>
            <div className="glass-card p-5 sm:p-8 border-l-4 border-l-[#7b4fce]">
              <div className="text-xs text-[#7b4fce] font-bold uppercase mb-2">[ PUBLIC RELEASE ROADMAP ]</div>
              <h4 className="text-lg sm:text-xl text-white font-bold mb-3 sm:mb-4 uppercase">Standard Subscription</h4>
              <p className="text-xs text-slate-400 uppercase leading-relaxed mb-4 sm:mb-6">
              ...
              <div className="text-base sm:text-lg text-[#7b4fce] font-bold uppercase tracking-widest">Pricing Disclosed Upon V2 Release</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ═══════════ 8. FAQ & FINAL CTA ═══════════ */}
      <section id="get-started" className="relative px-4 sm:px-6 py-12 sm:py-16 md:py-24 overflow-hidden animate-fade-in-up" style={{ background: '#0b1120' }}>
        <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white mb-6 sm:mb-10">
            Ready to reshape how they{' '}
            <span className="text-[#7b4fce] text-glow-magenta">learn?</span>
          </h3>
          <Link href="/beta" className="btn-neon-filled animate-pulse-glow mb-10 sm:mb-16 inline-block min-h-[48px] px-8 py-3.5 leading-relaxed">
            JOIN EARLY ACCESS
          </Link>

          {/* FAQ */}
          <div className="glass-card p-5 sm:p-8 text-left max-w-3xl mx-auto mt-6 sm:mt-12 border-t-2 border-t-[#00c8ff]">
