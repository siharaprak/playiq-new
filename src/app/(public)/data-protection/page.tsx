    ...
    <main className="w-full min-h-screen" style={{ background: '#020617' }}>
      <section className="relative py-20 px-6 border-b border-slate-800/50 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 right-[10%] w-[400px] h-[400px] bg-[rgba(255,0,255,0.05)] rounded-full blur-[120px]" />
        </div>
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          <p className="font-display text-xs uppercase tracking-[0.3em] text-[#ff00ff] mb-4">Legal</p>
          <h1 className="font-display font-black text-4xl md:text-5xl text-white tracking-widest uppercase drop-shadow-[0_0_20px_rgba(255,0,255,0.3)]">
            Data <span className="text-[#ff00ff]">Protection</span>
          </h1>
      ...
      <section className="py-16 px-6">
        <div className="mx-auto max-w-3xl space-y-10 text-slate-400 leading-relaxed">
          ...
          <div className="glass-card p-8">
            <h2 className="font-display text-sm uppercase tracking-[0.2em] text-[#00f2ff] font-bold mb-4">Overview</h2>
          ...
          <div className="glass-card p-8">
            <h2 className="font-display text-sm uppercase tracking-[0.2em] text-[#00f2ff] font-bold mb-4">Data Governance</h2>
          ...
          <div className="glass-card p-8">
            <h2 className="font-display text-sm uppercase tracking-[0.2em] text-[#00f2ff] font-bold mb-4">Technical Security Measures</h2>
          ...
          <div className="glass-card p-8">
            <h2 className="font-display text-sm uppercase tracking-[0.2em] text-[#00f2ff] font-bold mb-4">Student Data Protection</h2>
          ...
          <div className="glass-card p-8">
            <h2 className="font-display text-sm uppercase tracking-[0.2em] text-[#00f2ff] font-bold mb-4">Payment Security</h2>
          ...
          <div className="glass-card p-8">
            <h2 className="font-display text-sm uppercase tracking-[0.2em] text-[#00f2ff] font-bold mb-4">Data Retention</h2>
          ...
          <div className="glass-card p-8">
            <h2 className="font-display text-sm uppercase tracking-[0.2em] text-[#00f2ff] font-bold mb-4">Incident Response</h2>
          ...
          <div className="glass-card p-8">
            <h2 className="font-display text-sm uppercase tracking-[0.2em] text-[#00f2ff] font-bold mb-4">Contact</h2>
          ...
          <div className="flex flex-wrap justify-center gap-6 pt-4 border-t border-slate-800/50">
            ...
            <Link href="/terms" className="text-sm text-slate-500 hover:text-[#00f2ff] transition-colors">Terms of Service →</Link>
          </div>
        </div>
      </section>
    </main>
