    ...
    <main className="w-full bg-[#020617] star-field min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 py-28 relative z-10 space-y-16">
        <section className="text-center border-b-2 border-slate-800 pb-10">
          <h1 className="font-display font-black text-4xl md:text-5xl uppercase tracking-widest text-[#00c8ff] drop-shadow-[0_0_15px_rgba(0,200,255,0.4)] mb-4">
            SUPPORT & FAQs
          </h1>
        ...
        <section className="grid md:grid-cols-2 gap-16">
          <div className="glass-card p-8 border-l-[3px] border-l-[#00c8ff] !rounded-none">
            <h2 className="font-display text-2xl font-bold text-white mb-6 uppercase tracking-[0.2em] drop-shadow-[0_0_5px_#00c8ff]">&gt; SEND A MESSAGE</h2>
            ...
            <form className="space-y-6 font-mono text-sm">
               <div>
                <label className="block text-[#00c8ff] uppercase tracking-widest mb-2 opacity-80">YOUR EMAIL</label>
                <input type="email" className="neon-input !rounded-none !border-b-2 !border-b-slate-700 focus:!border-b-[#00c8ff] !bg-black/40 text-white" placeholder="ENTER EMAIL" />
              </div>
              <div>
                <label className="block text-[#00c8ff] uppercase tracking-widest mb-2 opacity-80">MESSAGE</label>
              ...
              <button type="button" className="font-display uppercase font-bold text-sm tracking-[0.2em] text-[#020617] bg-[#00c8ff] px-6 py-3 hover:bg-[#7b4fce] hover:text-white transition-colors border-2 border-[#00c8ff] shadow-[0_0_10px_#00c8ff] w-full">
                SEND MESSAGE
              </button>
            </form>
          </div>

          <div className="glass-card p-8 border-r-[3px] border-r-[#7b4fce] !rounded-none">
            <h2 className="font-display text-2xl font-bold text-white mb-6 uppercase tracking-[0.2em] drop-shadow-[0_0_5px_#7b4fce]">&gt; FAQs</h2>
            <div className="space-y-8 font-mono text-xs text-slate-300">
               <div className="border border-[rgba(123,79,206,0.2)] bg-black/40 p-4 relative">
                 <div className="absolute left-0 top-0 bottom-0 w-1 bg-[#7b4fce]"></div>
                 <h3 className="text-[#7b4fce] uppercase font-bold tracking-widest mb-2">Q: RETURN_POLICY_OVERRIDE</h3>
               ...
               <div className="border border-[rgba(123,79,206,0.2)] bg-black/40 p-4 relative">
                 <div className="absolute left-0 top-0 bottom-0 w-1 bg-[#7b4fce]"></div>
                 <h3 className="text-[#7b4fce] uppercase font-bold tracking-widest mb-2">Q: HARDWARE_DEPLOYMENT</h3>
               ...
               <div className="border border-[rgba(123,79,206,0.2)] bg-black/40 p-4 relative">
                 <div className="absolute left-0 top-0 bottom-0 w-1 bg-[#7b4fce]"></div>
                 <h3 className="text-[#7b4fce] uppercase font-bold tracking-widest mb-2">Q: LOCAL_DEVICE_SPECS</h3>
