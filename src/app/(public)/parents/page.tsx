    ...
    <main className="w-full bg-[#020617] star-field min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 py-28 relative z-10 space-y-20">
        ...
        <section className="text-center">
          <h1 className="font-display font-black text-4xl md:text-6xl uppercase tracking-widest text-[#00c8ff] drop-shadow-[0_0_15px_rgba(0,200,255,0.4)] mb-6">
            PROOF NOT PROMISES
          </h1>
        ...
        <section className="glass-card p-10 !rounded-none !border-t-0 !border-b-0 border-x-4 border-l-[#00c8ff] border-r-[#7b4fce]">
          <div className="grid md:grid-cols-2 gap-16 items-center">
             <div className="border border-[rgba(123,79,206,0.3)] bg-black h-80 relative overflow-hidden flex items-center justify-center">
              ...
              <span className="font-display tracking-[0.4em] text-xs text-[#7b4fce] z-10">[ PHOTO_EVIDENCE ]</span>
            </div>
            <div className="font-mono text-xs text-slate-300 uppercase tracking-widest leading-[2]">
              <h2 className="font-display text-xl text-white mb-6 tracking-[0.2em] border-b border-[#00c8ff] pb-4 inline-block">&gt; WHY THIS IS DIFFERENT</h2>
        ...
        <section className="text-center">
          <h2 className="font-display text-2xl uppercase tracking-[0.3em] text-[#7b4fce] mb-12">&gt; WHAT PARENTS SEE</h2>
        ...
        <section className="text-center pt-8 pb-10">
           <Link href="/beta" className="inline-block font-display uppercase font-bold text-xl tracking-[0.3em] text-[#020617] bg-[#00c8ff] px-10 py-5 hover:bg-[#7b4fce] transition-colors border-2 border-white shadow-[0_0_20px_#00c8ff]">
              JOIN EARLY ACCESS
           </Link>
        </section>
      </div>
