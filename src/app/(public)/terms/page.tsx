    ...
    <main className="w-full min-h-screen" style={{ background: '#020617' }}>
      <section className="relative py-12 sm:py-20 px-4 sm:px-6 border-b border-slate-800/50 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-[20%] w-[400px] h-[400px] bg-[rgba(0,200,255,0.05)] rounded-full blur-[120px]" />
        </div>
      ...
      <section className="py-8 sm:py-16 px-4 sm:px-6">
        <div className="mx-auto max-w-3xl space-y-6 sm:space-y-10 text-slate-400 leading-relaxed text-xs sm:text-sm">
          ...
          <div className="glass-card p-5 sm:p-8">
            <h2 className="font-display text-xs sm:text-sm uppercase tracking-[0.15em] sm:tracking-[0.2em] text-[#00c8ff] font-bold mb-3 sm:mb-4">1. Acceptance of Terms</h2>
          ...
          <div className="glass-card p-8">
            <h2 className="font-display text-sm uppercase tracking-[0.2em] text-[#00c8ff] font-bold mb-4">5. Permitted Use</h2>
          ...
          <div className="glass-card p-8">
            <h2 className="font-display text-sm uppercase tracking-[0.2em] text-[#00c8ff] font-bold mb-4">7. AI Mentor Disclaimer</h2>
          ...
          <div className="glass-card p-8">
            <h2 className="font-display text-sm uppercase tracking-[0.2em] text-[#00c8ff] font-bold mb-4">8. Disclaimers & Limitation of Liability</h2>
          ...
          <div className="glass-card p-8">
            <h2 className="font-display text-sm uppercase tracking-[0.2em] text-[#00c8ff] font-bold mb-4">10. Governing Law</h2>
          ...
          <div className="glass-card p-8">
            <h2 className="font-display text-sm uppercase tracking-[0.2em] text-[#00c8ff] font-bold mb-4">11. Changes to Terms</h2>
