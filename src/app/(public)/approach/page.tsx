    ...
    <main className="w-full bg-[#020617] star-field min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 py-28 relative z-10 space-y-20">
        <section className="text-center">
          <p className="font-display uppercase tracking-[0.4em] text-[0.65rem] text-[#7b4fce] opacity-80 mb-4">&gt; PLAYIQ APPROACH</p>
          ...
          <p className="font-mono text-sm max-w-3xl mx-auto text-slate-400 capitalize bg-[rgba(0,200,255,0.05)] p-4 border border-[rgba(0,200,255,0.2)]">
            We designed our logic engine to teach resilience, not dependency. Effort is mandatory before answers are decrypted.
          </p>
        </section>

        {/* The Why */}
        <section className="glass-card p-10 !rounded-none !border-l-0 !border-r-0 border-y-4 border-t-[#00c8ff] border-b-[#7b4fce]">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="border border-[rgba(0,200,255,0.3)] bg-black h-80 relative overflow-hidden flex items-center justify-center">
              ...
              <span className="font-display tracking-[0.4em] text-xs text-[#00c8ff] z-10">[ APP PREVIEW ]</span>
            </div>
          </div>
        </section>
        ...
        <section className="text-center font-mono">
           ...
           <div className="grid md:grid-cols-3 gap-8 text-left">
             <div className="glass-card p-8 border border-[rgba(0,200,255,0.2)] !rounded-none">
                <div className="text-[#00c8ff] font-display text-3xl font-bold mb-4 drop-shadow-[0_0_5px_#00c8ff]">[01]</div>
             ...
             <div className="glass-card p-8 border border-[rgba(123,79,206,0.2)] !rounded-none">
                <div className="text-[#7b4fce] font-display text-3xl font-bold mb-4 drop-shadow-[0_0_5px_#7b4fce]">[02]</div>
             ...
             <div className="glass-card p-8 border border-[rgba(0,200,255,0.2)] !rounded-none">
                <div className="text-[#00c8ff] font-display text-3xl font-bold mb-4 drop-shadow-[0_0_5px_#00c8ff]">[03]</div>
        ...
        <section className="text-center pt-8 border-t border-slate-800">
           <Link href="/beta" className="font-display uppercase font-bold text-sm tracking-[0.2em] text-[#7b4fce] underline hover:text-white transition-colors">
              JOIN EARLY ACCESS &gt;
           </Link>
        </section>
      </div>
