...
async function main() {
  const recipient = 'ivllnv.000@gmail.com';
  console.log(`Sending Amazon SES test email to: ${recipient}...`);
...
<body>
  <div class="container">
    ...
    <p style="font-size: 14px; color: #cbd5e1; line-height: 1.6;">
      Welcome to the <strong>WePlayIQ Beta Testing Program</strong>! We've attached the complete <strong>Parent Setup Guide PDF</strong> to this email so you have all the steps right in your inbox.
    </p>

    <div class="section-card">
      <h3 style="color: #ffffff; margin-top: 0; font-size: 15px;">🛡️ Parent Setup Steps:</h3>
  ...
  try {
    const info = await transporter.sendMail({
      from: `"WePlayIQ" <${env.AWS_SES_FROM_EMAIL || 'sender@sienvi.com'}>`,
